...
var file_input_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x50, 0x0a, 0x12, 0x63, 0x6f, 0x6d,
	0x2e, 0x73, 0x6f, 0x75, 0x73, 0x74, 0x69, 0x66, 0x79, 0x2e, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x5a,
	0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x75, 0x73,
	...
	0x69, 0x6e, 0x70, 0x75, 0x74, 0x3b, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_input_proto_goTypes = []interface{}{
	...
	(*UUIDRequest)(nil),         // 1: input.UUIDRequest
	(*FilteredRequest)(nil),     // 2: input.FilteredRequest
	(*FilterFieldsRequest)(nil), // 3: input.FilterFieldsRequest
	(*OrderByRequest)(nil),      // 4: input.OrderByRequest
}
var file_input_proto_depIdxs = []int32{
	2, // 0: input.PaginationRequest.filter:type_name -> input.FilteredRequest
	4, // 1: input.PaginationRequest.order_by:type_name -> input.OrderByRequest
	3, // 2: input.FilteredRequest.filtered_fields:type_name -> input.FilterFieldsRequest
